      ...
      <div className="grid md:grid-cols-2 gap-6">
        ...
        <div className="p-8 bg-card border border-border rounded-xl flex flex-col">
          ...
          <h3 className="font-display text-2xl font-semibold mb-3">
            Interview once. Let your work speak.
          </h3>
          <p className="text-muted-foreground text-sm mb-6 leading-relaxed">
            Stop explaining the same project for the fifteenth time. Take a
            rigorous technical interview, get a detailed verified report, and
            share it with every company that&apos;s interested.
          </p>
        ...
        <div className="p-8 bg-primary text-primary-foreground rounded-xl flex flex-col">
          ...
          <h3 className="font-display text-2xl font-semibold mb-3">
            Hire from evidence, not first impressions.
          </h3>
          <p className="text-sm opacity-80 mb-6 leading-relaxed">
            Every candidate in Verquo has already been through a structured
            technical interview. You see timestamped evidence of their actual
            thinking — not a polished resume or a referral.
          </p>
          <ul className="space-y-2 mb-8">
