      ...
      <div className="lg:col-span-2 flex flex-col gap-6">
            ...
            {[
              {
                ...
                desc: "Led frontend architecture for a B2B SaaS platform serving 40,000 daily users. Reduced initial bundle size by 62% and improved Core Web Vitals scores across all routes.",
              },
              {
                role: "Frontend Developer",
                company: "StartupXYZ",
                period: "Jun 2018 – Feb 2021",
                desc: "Built and maintained the company's design system and component library used by 5 product teams. Migrated codebase from class components to hooks.",
              },
            ].map((exp, i) => (
              <div
                key={i}
        ...
        <Card>
          ...
          <CardContent>
            ...
            <div className="text-sm text-muted-foreground">
              Indian Institute of Technology, Bombay · 2014–2018 · GPA 8.6/10
            </div>
          </CardContent>
        </Card>
      </div>
        ...
        <Card>
          ...
          <CardContent className="flex flex-col gap-2 text-sm">
            ...
            <div className="flex justify-between">
              ...
              <span className="text-xs">Bangalore, Remote</span>
            </div>
          </CardContent>
        </Card>
      </div>
