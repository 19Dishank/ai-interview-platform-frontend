    ...
    <>
      <div className="flex items-center justify-between mb-6">
        <button
          ...
          className="flex items-center gap-2 text-muted-foreground hover:text-foreground text-sm transition-colors cursor-pointer"
        >
        ...
        <div className="flex gap-2">
          <Button
            variant="outline"
            size="sm"
            onClick={() => router.push("/recruiter/compare")}
          >
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-2 mt-3">
                    ...
                    <Badge variant="outline">
                      {candidate.domain} · {candidate.technology}
                    </Badge>
                    <Badge variant="outline">{candidate.level}</Badge>
                    <Badge variant="warning">
                      {candidate.difficulty} interview
                    </Badge>
                  </div>
                </div>
