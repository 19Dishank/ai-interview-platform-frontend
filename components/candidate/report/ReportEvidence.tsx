...
export default function ReportEvidence({ evidenceItems }: ReportEvidenceProps) {
  return (
    <Card className="mb-6">
      <CardHeader>
        <CardTitle>Interview evidence timeline</CardTitle>
      </CardHeader>
      <CardContent>
        <p className="text-xs text-muted-foreground mb-5">
          Timestamped moments where notable technical ability or reasoning was
          demonstrated. These are direct observations, not inferences.
        </p>
