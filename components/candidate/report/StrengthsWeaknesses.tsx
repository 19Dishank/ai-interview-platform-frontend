  ...
  return (
    <div className="grid lg:grid-cols-2 gap-6 mb-6">
      ...
      <Card>
        <CardHeader>
          <CardTitle className="flex items-center gap-2">
            <AlertTriangle size={16} className="text-accent" /> Areas for growth
          </CardTitle>
        </CardHeader>
        <CardContent>
          <ul className="flex flex-col gap-3">
          ...
          <div className="mt-4 p-3 bg-accent/8 border border-accent/20 rounded-lg">
            <p className="text-xs text-muted-foreground">
              These are growth observations, not disqualifiers. They reflect the
              honest output of a rigorous assessment.
            </p>
          </div>
        </CardContent>
      </Card>
