    ...
    <>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4 mb-8">
        ...
        <StatCard
          ...
          value={mockAdminStats.totalRecruiters.toLocaleString()}
          trend="8% this month"
        />
        <StatCard
          label="Interviews this month"
          value={mockAdminStats.interviewsThisMonth.toLocaleString()}
          trend="21% MoM"
        />
        <StatCard
          label="Active job postings"
          value={mockAdminStats.activeJobs.toLocaleString()}
        />
        <StatCard
          label="Avg. interview score"
          value={mockAdminStats.avgScore}
          sub="/ 100"
        />
        <StatCard
