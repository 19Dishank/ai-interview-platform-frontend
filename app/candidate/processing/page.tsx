        ...
        {!done ? (
          <>
            ...
            <p className="text-muted-foreground text-sm mb-8">
              This usually takes 60–90 seconds. Please don&apos;t close this
              tab.
            </p>
            <div className="flex flex-col gap-2 text-left">
              {stages.map((s, i) => (
                <div
                  key={s}
                  className={`flex items-center gap-3 text-sm transition-colors duration-300 ${i < stageIdx ? "text-success" : i === stageIdx ? "text-foreground" : "text-muted-foreground/40"}`}
                >
                  {i < stageIdx ? (
          ...
          <div>
            ...
            <p className="text-muted-foreground text-sm">
              Your assessment report has been generated. Redirecting…
            </p>
          </div>
        )}
      </div>
