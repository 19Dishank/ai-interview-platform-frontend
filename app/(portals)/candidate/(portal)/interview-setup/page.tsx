...
const difficulties = [
  {
    id: "Easy",
    label: "Easy",
    desc: "~40 min · Fundamentals, basic problem-solving",
  },
  {
    id: "Medium",
    label: "Medium",
    desc: "~50 min · Applied knowledge, design basics",
  },
  {
    id: "Hard",
    label: "Hard",
    desc: "~65 min · System design, deep technical depth",
  },
];
  ...
  return (
    <>
      <PageHeader
        ...
        subtitle="Configure your interview before you start. This selection determines the questions you'll receive."
      />
            ...
            <div className="flex flex-wrap gap-2">
              {domains.map((d) => (
                <button
                  ...
                  onClick={() => {
                    setDomain(d);
                    setTech(techByDomain[d][0]);
                  }}
                  className={cn(
                    "px-4 py-2 rounded-md text-sm border transition-all cursor-pointer",
                    domain === d
            ...
            <div className="flex flex-col gap-3">
              {difficulties.map((d) => (
                <button
                  ...
                  className={cn(
                    "flex items-center gap-4 p-4 rounded-lg border text-left transition-all cursor-pointer",
                    difficulty === d.id
        ...
        <div className="p-5 bg-card border border-border rounded-xl">
          ...
          <div className="flex items-start gap-2 p-3 bg-accent/10 border border-accent/20 rounded-lg mb-4">
            ...
            <p className="text-xs text-muted-foreground">
              Once started, the interview cannot be paused. Make sure you are in
              a quiet environment with a stable internet connection. Your
              microphone will be used throughout.
            </p>
          </div>
          <Button
            className="w-full"
